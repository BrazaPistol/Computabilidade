...
public class RegrasSintaticas {
    ...
    boolean DECLARACAO_VARIAVEL(ArrayList<ClassificacaoLexica> VetorAnaliseLexica){
        ...
        if((VetorAnaliseLexica.get(0).Token == Token.FLOAT) && (VetorAnaliseLexica.get(1).Token == Token.VARIAVEL) || (VetorAnaliseLexica.get(0).Token == Token.FLOAT) && (VetorAnaliseLexica.get(1).Token == Token.VARIAVEL)
                && (VetorAnaliseLexica.get(2).Token == Token.ATRIBUICAO) && (VetorAnaliseLexica.get(3).Token == Token.NUM_DECIMAL)) {
            return true;
        }
        ...
        if((VetorAnaliseLexica.get(0).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(1).Token == Token.ATRIBUICAO) && (VetorAnaliseLexica.get(2).Token == Token.NUM_DECIMAL)) {
            return true;
        }

        if((VetorAnaliseLexica.get(0).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(1).Token == Token.ATRIBUICAO) && (VetorAnaliseLexica.get(2).Token == Token.NUM_DECIMAL) && (VetorAnaliseLexica.get(3).Token == Token.MULTIPLICACAO)
    ...
    boolean COMANDO_FOR(ArrayList<ClassificacaoLexica> VetorAnaliseLexica){
        ...
        if ((VetorAnaliseLexica.get(0).Token == Token.FOR) && (VetorAnaliseLexica.get(1).Token == Token.FOR_LOOP) &&
                (VetorAnaliseLexica.get(2).Token == Token.FOR_LOOP) && (VetorAnaliseLexica.get(3).Token == Token.FOR_LOOP)){
            return true;
        } else
            return false;
    }
    ...
    boolean PRINTLN(ArrayList<ClassificacaoLexica> VetorAnaliseLexica){
        ...
        if ((VetorAnaliseLexica.get(0).Token == Token.PRINT) && (VetorAnaliseLexica.get(1).Token == Token.ABRE_PARENTESE &&
                (VetorAnaliseLexica.get(2).Token == Token.STRING) && (VetorAnaliseLexica.get(3).Token == Token.FECHA_PARENTESE))){
            return true;
        }
        ...
        if ((VetorAnaliseLexica.get(0).Token == Token.PRINT) && (VetorAnaliseLexica.get(1).Token == Token.STRING &&
                (VetorAnaliseLexica.get(2).Token == Token.FECHA_PARENTESE))){
            return true;
        }
        if ((VetorAnaliseLexica.get(0).Token == Token.PRINT) && (VetorAnaliseLexica.get(1).Token == Token.STRINGFORMATO &&
                (VetorAnaliseLexica.get(2).Token == Token.MATRIZ))){
            return true;
        }
        if ((VetorAnaliseLexica.get(0).Token == Token.PRINT) && (VetorAnaliseLexica.get(1).Token == Token.QUEBRA_DE_LINHA &&
                (VetorAnaliseLexica.get(2).Token == Token.FECHA_PARENTESE))){
            return true;
        }
        if ((VetorAnaliseLexica.get(0).Token == Token.PRINT) && (VetorAnaliseLexica.get(1).Token == Token.STRING &&
    ...
    boolean SCANF(ArrayList<ClassificacaoLexica> VetorAnaliseLexica) {
        ...
        if ((VetorAnaliseLexica.get(0).Token == Token.SCANF) && (VetorAnaliseLexica.get(1).Token == Token.ABRE_PARENTESE) ||
                (VetorAnaliseLexica.get(0).Token == Token.STRINGFORMATO)  && (VetorAnaliseLexica.get(1).Token == Token.SCANF_FUNCAO)) {

            return true;
        }

        if ((VetorAnaliseLexica.get(0).Token == Token.SCANF) && (VetorAnaliseLexica.get(1).Token == Token.STRINGFORMATO) ||
                (VetorAnaliseLexica.get(0).Token == Token.SCANF_FUNCAO)) {
    ...
    boolean COMENTARIO(ArrayList<ClassificacaoLexica> VetorAnaliseLexica) {
        ...
        if ((VetorAnaliseLexica.get(0).Token == Token.COMENTARIOS)) {
    ...
    boolean WHILE(ArrayList<ClassificacaoLexica> VetorAnaliseLexica) {
        ...
        if ((VetorAnaliseLexica.get(0).Token == Token.WHILE) && (VetorAnaliseLexica.get(1).Token == Token.ABRE_PARENTESE) && (VetorAnaliseLexica.get(2).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(3).Token == Token.MAIORQUE) &&
                (VetorAnaliseLexica.get(4).Token == Token.NUM_INTEIRO) && (VetorAnaliseLexica.get(5).Token == Token.E) && (VetorAnaliseLexica.get(6).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(7).Token == Token.MENORQUE) &&
                (VetorAnaliseLexica.get(8).Token == Token.NUM_INTEIRO) && (VetorAnaliseLexica.get(9).Token == Token.FECHA_PARENTESE)) {
            return true;
        }
        return false;
    }
    ...
    boolean IF(ArrayList<ClassificacaoLexica> VetorAnaliseLexica) {
        ...
        if ((VetorAnaliseLexica.get(0).Token == Token.IF) &&
                ...
                (VetorAnaliseLexica.get(13).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(14).Token == Token.MENORQUE)  && (VetorAnaliseLexica.get(15).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(16).Token == Token.ADICAO) && (VetorAnaliseLexica.get(17).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(18).Token == Token.FECHA_PARENTESE)
                && (VetorAnaliseLexica.get(19).Token == Token.ABRE_CHAVE)) {
            return true;
        }
        if ((VetorAnaliseLexica.get(0).Token == Token.IF) &&
                (VetorAnaliseLexica.get(1).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(2).Token == Token.INSERCAO)  && (VetorAnaliseLexica.get(3).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(4).Token == Token.E) &&
                (VetorAnaliseLexica.get(5).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(6).Token == Token.INSERCAO)  && (VetorAnaliseLexica.get(7).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(8).Token == Token.E) &&
                (VetorAnaliseLexica.get(9).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(10).Token == Token.INSERCAO)  && (VetorAnaliseLexica.get(11).Token == Token.VARIAVEL)) {
            return true;
        }
    ...
    boolean ELSEIF(ArrayList<ClassificacaoLexica> VetorAnaliseLexica) {
        if ((VetorAnaliseLexica.get(0).Token == Token.ELSE) && (VetorAnaliseLexica.get(1).Token == Token.IF) && (VetorAnaliseLexica.get(2).Token == Token.ABRE_PARENTESE)  &&
                (VetorAnaliseLexica.get(3).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(4).Token == Token.INSERCAO) && (VetorAnaliseLexica.get(5).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(6).Token == Token.OU) &&
                (VetorAnaliseLexica.get(7).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(8).Token == Token.INSERCAO) && (VetorAnaliseLexica.get(9).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(10).Token == Token.OU) &&
                (VetorAnaliseLexica.get(11).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(12).Token == Token.INSERCAO) && (VetorAnaliseLexica.get(13).Token == Token.VARIAVEL) && (VetorAnaliseLexica.get(14).Token == Token.FECHA_PARENTESE)) {
            return true;
        }
        else return false;
    }
    ...
    boolean ELSE(ArrayList<ClassificacaoLexica> VetorAnaliseLexica) {
        ...
        if ((VetorAnaliseLexica.get(0).Token == Token.ELSE) && (VetorAnaliseLexica.get(1).Token == Token.PRINT) && (VetorAnaliseLexica.get(2).Token == Token.ABRE_PARENTESE) &&
                (VetorAnaliseLexica.get(3).Token == Token.STRING)  && (VetorAnaliseLexica.get(4).Token == Token.FECHA_PARENTESE)) {
            return true;
        }
        if ((VetorAnaliseLexica.get(0).Token == Token.ELSE) && (VetorAnaliseLexica.get(1).Token == Token.PRINT) && (VetorAnaliseLexica.get(2).Token == Token.ABRE_PARENTESE) &&
